<?php
	require 'dbconfig/connectfaculty.php';
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<div id="main-wrapper">	
		<center>
			<font color="white"><h2>Faculty Registration Form</h2></font>
			<img src="imgs/8-512.png" class="avatar"/>
		</center>
		<form class="myform" action="facultyindex.php" method="post">
			...
			<input name= "submitbtn1" type="submit" id="signupbtn" value="Sign Up"/>
			<a href="facultyindex.php"><input type="button" id="backbtn" value="<<Back to Login"/>
		</form>	
		<?php
			...
			if(isset($_POST['submitbtn1']))
			{
				...
				{
					$query="select * from faculty_details where username='$username'";
					...
					{
						$query= "insert into faculty_details values('$username','$password')";
						$queryrun= mysqli_query($con,$query);
						if($queryrun)
						{
