...
<body>
	...
	<div id="main-wrapper">	
		<center>
			<font color="white"><h2>Faculty Login</h2></font>
		...
		<form class="myform" action="facultyindex.php" method="post">
			...
			<a href= "facultyreg.php"><input type="button" id="registerbtn" value="Register"/>
		...
		if(isset($_POST['loginbtn']))
			{
				...
				$query="select * from faculty_details where username='$username' and password='$password'";
